...
const releaseTarballUrl = await latestReleaseDownloadLink('callstackincubator', 'ElryaAi')
...
if (!process.env.OPENAI_API_KEY) {
  log.warning(
    'No OPENAI_API_KEY found in environment variables. Elrya starter projects use OpenAI and require an API key.'
  )
